...
public class UIDiceSelection : MonoBehaviour {
	...
	public void SetupPanel() {
		effortPointsRequired.text = quest.Reqs[skill].RequiredValue.ToString();
		effortPointsText.text = "of my <b>" + quest.Reqs[skill].RequiredValue.ToString() + " " + skill.ToString() + "</b> dice.";
		...
		string effortMessage = "This task requires <b>" + quest.Reqs[skill].RequiredValue.ToString() + " " + skill.ToString() + " Effort Points</b> to complete.";
